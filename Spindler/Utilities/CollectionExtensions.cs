...
namespace Spindler.Utilities
{
    public static class CollectionExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="T">Any <see cref="IIndexedModel"/> for sorting uurposes</typeparam>
        ...
        public static void ExecuteAddAndDeleteTransactions<T>(this ObservableCollection<T> baseCollection, IEnumerable<T> targetValues) where T : IIndexedModel
        {
            ...
            IList<T> valuesToDelete = baseCollection.Where(item => !targetIds.Contains(item.GetId())).ToImmutableArray();
